...
var _image3Jpg = require("./assets/image3.jpg");
...
const model = [
    ...
    new (0, _blocks.ImageBlock)((0, _image3JpgDefault.default), {
        styles: {
            padding: "2rem 0",
            display: "flex",
    ...
    new (0, _blocks.TextBlock)("Some text", {
        styles: {
...
},{"./assets/image3.jpg":"5w04k","./classes/blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5w04k":[function(require,module,exports) {
module.exports = require("2f830d81efc9a1b3").getBundleURL("bLxZJ") + "image3.1256f61b.jpg" + "?" + Date.now();

},{"2f830d81efc9a1b3":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
class ImageBlock extends Block {
    ...
    toHTML() {
        ...
        return (0, _utils.row)(`<img src="${this.value}" alt="${alt}" style="${(0, _utils.css)(imageStyles)}">`, (0, _utils.css)(styles));
    }
}
...
function css(styles = {}) {
    ...
    const keyToString = (key)=>`${key}: ${styles[key]}`;
    return Object.keys(styles).map(keyToString).join(";");
}
function block(type) {
    return `
        <form name="${type}">
...
class App {
    ...
    init() {
        ...
        const sidebar = new (0, _sidebar.Sidebar)("#panel", updateCallback);
    }
}
...
},{"../utils":"en4he","./blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"clPKd":[function() {},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire39dc")
